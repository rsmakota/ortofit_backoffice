BackOffice.ReportForwarder = {
    ...
    init: function()
    {
        var hlp = BackOffice.ReportForwarderHelper;
        var me = this;
    ...
    isDate: function (dateStr) {
        var me = BackOffice.ReportForwarder;
    ...
    _renderResponse: function (msg) {
        ...
        var content = '<table class="table table-striped">' +
            ...
            '<tbody>';
             for (var forwarderName in data) {
                content += '<tr><td>'+forwarderName+'</td><td>'+data[forwarderName]+'</td></tr>';
            }
